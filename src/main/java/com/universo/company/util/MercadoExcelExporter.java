...
public class MercadoExcelExporter {
	...
	public MercadoExcelExporter(List<Mercado> mercados) {
	...
	private void writeDataLines() {
		...
		// Recorremos la lista de categorias que hay que almacenar en el excel
		for (Mercado result: mercado) {
