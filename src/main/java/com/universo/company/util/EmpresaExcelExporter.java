package com.universo.company.util;
...
public class EmpresaExcelExporter {
	...
	public EmpresaExcelExporter(List<Empresa> empresas) {
	...
	private void writeDataLines() {
		...
		// Recorremos la lista de empresas que hay que almacenar en el excel
		for (Empresa result: empresa) {
			...
			createCell(row, columnCount++, String.valueOf(result.getClave()), style);
			createCell(row, columnCount++, String.valueOf(result.getDescripcion()), style);
			createCell(row, columnCount++, String.valueOf(result.getCapital()), style);
			createCell(row, columnCount++, String.valueOf(result.getMercado().getClave()), style);
